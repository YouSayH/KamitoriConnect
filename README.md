...
| --- | --- | --- | --- |
| **管理者**<br>(Admin) | 商店街組合、運営事務局 | `kamitori_admin` | ・全店舗データの管理・編集<br>・全ユーザーの管理<br>・システム全体設定の変更 |
| **店舗オーナー**<br>(Shop Owner) | 各店舗の店主・スタッフ | `kamitori_owner` | ・自店舗情報の登録・編集<br>・AI記事作成（写真アップロード）<br>・SNS投稿の実行<br>・自店舗に関する翻訳内容の確認 |
