...
<br>(Admin) | 商店街組合、運営事務局 | `kamitori_admin` | ・全店舗データの管理・編集<br>
...
<br>(Shop Owner) | 各店舗の店主・スタッフ | `kamitori_owner` | ・自店舗情報の登録・編集<br>

<br>・AI記事作成（写真アップロード）<br>
...
<br>(Guest) | 上通を訪れるお客様 | (不要) | ・AI観光コンシェルジュ (チャット) の利用<br>
